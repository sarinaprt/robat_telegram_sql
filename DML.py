...
def database_exsist(database):
    try:
        ...
        print(f"problem in database_exist {e}⚠️ ")
...
def customers():
    try:
        ...
        print(f"problem in table_custom {e}⚠️ ")
...
def book_info():
    try:
        ...
        print(f"problem in table_book {e}⚠️ ")
...
def theater_ticket():
    try:
        ...
        cur.execute("""CREATE TABLE ticket(
                    ...
                    title     NVARCHAR(50) NOT NULL,
                    gener     ENUM("Comedy","Drama","modern tragedy") NOT NULL,
        ...
        print(f"problem in table_theater_ticket {e}⚠️ ")
...
def orders():
    try:
        ...
        print(f"problem in table_orders {e}⚠️ ")
